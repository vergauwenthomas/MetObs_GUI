...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Load gui widgets
        loadUi(os.path.join(path_handler.GUI_dir,
                            'qt_windows','mainwindow.ui'),
               self) #open the ui file

        # -------- Information to pass beween different triggers ----------
        self.Dataset = metobs_toolkit.Dataset() #the vlindertoolkit dataset instance
        self.modeldata = None
        self.analysis = None
        ...
        # GUI settings
        # =============================================================================
        gui_settings_page.setup_triggers(self)
